...
\begin{itemize}
    \item \href{Simulation code}{https://github.com/sdaza/slides/blob/main/presentations/experimentation/code/simulations.py}
    \item \href{Experiment Utils}{https://github.com/sdaza/experiment-utils-pd}
\end{itemize}
